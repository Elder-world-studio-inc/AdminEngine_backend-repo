...
const OMNIVAEL_ASSETS = [
  {
    assetId: 'OM-BK-001',
    creatorId: '11111111-1111-4111-8111-111111111111', // Admin/Sara
    divisionId: 'creative',
  ...
  {
    assetId: 'OM-3D-002',
    creatorId: '44444444-4444-4444-8444-444444444444', // Wayfarer/Artist
    divisionId: 'wayfarer',
  ...
  {
    assetId: 'OM-CM-003',
    creatorId: '22222222-2222-4222-8222-222222222222', // Creative
    divisionId: 'creative',
    ipStatus: 'Work_for_Hire',
    legalSignatureStatus: 'NULL',
    status: 'DRAFT',
